...
export class AutoMigration1773254416360 implements MigrationInterface {
    name = 'AutoMigration1773254416360'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "gyms" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_At" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_At" TIMESTAMP WITH TIME ZONE NOT NULL, "name" character varying NOT NULL, "description" character varying, "phone" character varying NOT NULL, "email" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "country" character varying NOT NULL, "logo" character varying, "documents" text array, "isActive" boolean NOT NULL DEFAULT true, "ownerId" uuid, CONSTRAINT "PK_fe765086496cf3c8475652cddcb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_GYM_CITY" ON "gyms" ("city") `);
        await queryRunner.query(`CREATE INDEX "IDX_GYM_NAME" ON "gyms" ("name") `);
        await queryRunner.query(`CREATE TYPE "public"."user_role_enum" AS ENUM('super_admin', 'gym_admin', 'gym_staff', 'manager', 'trainer', 'user')`);
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_At" TIMESTAMP WITH TIME ZONE NOT NULL, "updated_At" TIMESTAMP WITH TIME ZONE NOT NULL, "username" character varying NOT NULL, "first_name" character varying NOT NULL, "middle_name" character varying NOT NULL, "last_name" character varying NOT NULL, "gender" character varying NOT NULL, "role" "public"."user_role_enum" NOT NULL DEFAULT 'user', "contact_number" character varying NOT NULL, "address" character varying NOT NULL, "city" character varying NOT NULL, "state" character varying NOT NULL, "country" character varying NOT NULL, "profile_picture" character varying NOT NULL, "gymId" uuid, CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "gyms" ADD CONSTRAINT "FK_521129f3c47351ebffbddc55dd2" FOREIGN KEY ("ownerId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user" ADD CONSTRAINT "FK_c28d9dd20dbe0ecad02042543a1" FOREIGN KEY ("gymId") REFERENCES "gyms"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user" DROP CONSTRAINT "FK_c28d9dd20dbe0ecad02042543a1"`);
