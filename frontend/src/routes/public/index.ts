...
const Signup = React.lazy(() => import("@/core/public/auth/register")); // Lazy-load the Login page component
...
export const publicRoutes: AppRouteObject[] = [
  ...
  createRoute({
    path: publicRoutePath.signup, // Use path constant instead of hardcoded string
    element: Signup, // Lazy-loaded Login component to render
    type: "auth", // Marks route as auth page — skips header in PublicLayout
    roles: [], // No role restriction for public routes
    title: "Signup", // Display title used for page metadata or breadcrumbs
    icon: null, // No sidebar/nav icon for this route
  }),
];
